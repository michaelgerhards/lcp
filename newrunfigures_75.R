...
boxplot(experiment$makespan ~ experiment$algorithm,ylim=c(8.0,16.0),ylab="makespan (h)", main="Epigenomics")
...
par(cex.axis=1.5)
#boxplot(experiment$makespan ~ experiment$algorithm,ylim=c(5.5,8.5),ylab="makespan (h)", main="epi ms")
boxplot(experiment$cost ~ experiment$algorithm, ylim=c(4000,5800), ylab="cost ($)", main="Epigenomics")
...
par(cex.lab=1.5)
par(cex.axis=1.5)
boxplot(experiment$makespan ~ experiment$algorithm, ylim=c(4.0,5.4), ylab="makespan (h)", main="Inspiral")
abline(h=mean(deadline$makespan),lty=2)
lines(c(0.6,1.4), c(LCP_a$makespan, LCP_a$makespan), lwd=2, lty=8)
lines(c(1.6,2.4), c(PCP_a$makespan, PCP_a$makespan), lwd=2, lty=8)
lines(c(2.6,3.4), c(SPSS_a$makespan, SPSS_a$makespan), lwd=2, lty=8)
...
par(cex.lab=1.5)
par(cex.axis=1.5)
boxplot(experiment$cost ~ experiment$algorithm, ylim=c(2800,4000), ylab="cost ($)", main="Inspiral")
...
par(cex.lab=1.5)
par(cex.axis=1.5)
boxplot(experiment$makespan ~ experiment$algorithm, ylim=c(5.5,8.0), ylab="makespan (h)", main="SIPHT")
abline(h=mean(deadline$makespan),lty=2)
lines(c(0.6,1.4), c(LCP_a$makespan, LCP_a$makespan), lwd=2, lty=8)
lines(c(1.6,2.4), c(PCP_a$makespan, PCP_a$makespan), lwd=2, lty=8)
lines(c(2.6,3.4), c(SPSS_a$makespan, SPSS_a$makespan), lwd=2, lty=8)
...
par(cex.lab=1.5)
par(cex.axis=1.5)
boxplot(experiment$cost ~ experiment$algorithm, ylim=c(650,950), ylab="cost ($)", main="SIPHT")
...
par(cex.lab=1.5)
par(cex.axis=1.5)
boxplot(experiment$makespan ~ experiment$algorithm, ylim=c(4.2,5.6), ylab="makespan (h)", main="Cybershake")
abline(h=mean(deadline$makespan),lty=2)
lines(c(0.6,1.4), c(LCP_a$makespan, LCP_a$makespan), lwd=2, lty=8)
lines(c(1.6,2.4), c(PCP_a$makespan, PCP_a$makespan), lwd=2, lty=8)
lines(c(2.6,3.4), c(SPSS_a$makespan, SPSS_a$makespan), lwd=2, lty=8)
...
par(cex.lab=1.5)
par(cex.axis=1.5)
boxplot(experiment$cost ~ experiment$algorithm, ylim=c(240,380), ylab="cost ($)", main="Cybershake")
...
par(cex.lab=1.5)
par(cex.axis=1.5)
boxplot(experiment$makespan ~ experiment$algorithm, ylim=c(5.6,6.4), ylab="makespan (h)", main="Montage")
abline(h=mean(deadline$makespan),lty=2)
lines(c(0.6,1.4), c(LCP_a$makespan, LCP_a$makespan), lwd=2, lty=8)
lines(c(1.6,2.4), c(PCP_a$makespan, PCP_a$makespan), lwd=2, lty=8)
lines(c(2.6,3.4), c(SPSS_a$makespan, SPSS_a$makespan), lwd=2, lty=8)
...
par(cex.lab=1.5)
par(cex.axis=1.5)
boxplot(experiment$cost ~ experiment$algorithm, ylim=c(2900,3200), ylab="cost ($)", main="Montage")
