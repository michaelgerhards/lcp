...
import algorithm.pbws2.strategies.aggregation.dr.fix.combinator.DR_FP_Succ_GapsAll_DifferSize_CScaleDown_FixedDL2;
import algorithm.pbws2.strategies.aggregation.dr.fix.combinator.DR_FP_Succ_GapsAll_DifferSize_TScale_FixedDL2;
import statics.initialization.impl.Lane;
import statics.util.Util;

public class DR_Manager_FP_Succ_GapsAll_DifferSize_FixedDL2 implements DR_Manager_DifferSize {

    public final DR_FP_Succ_GapsAll_DifferSize_CScaleDown_FixedDL2 dR_FP_Succ_GapsAllowed_DifferentSize_CScale_FixedDL;
    public final DR_FP_Succ_GapsAll_DifferSize_TScale_FixedDL2 dR_FP_Succ_GapsAllowed_DifferentSize_TScale_FixedDL;

    public DR_Manager_FP_Succ_GapsAll_DifferSize_FixedDL2() {
        dR_FP_Succ_GapsAllowed_DifferentSize_CScale_FixedDL = new DR_FP_Succ_GapsAll_DifferSize_CScaleDown_FixedDL2();
        dR_FP_Succ_GapsAllowed_DifferentSize_TScale_FixedDL = new DR_FP_Succ_GapsAll_DifferSize_TScale_FixedDL2();
    }
    ...
    private AggregationResult scaleUp(Lane lane1, Lane lane2) {
        ...
        if (lane2.getInstanceSize().isFaster(lane1.getInstanceSize())) {
            // scale up lane1
            ScaledPseudoLane newLane1 = lane1.tryScalingIdlFix(lane2.getInstanceSize());
            scaled = lane1;
            constant = lane2;
            newScaled = newLane1;
        } else {
            // scale up lane2
            ScaledPseudoLane newLane2 = lane2.tryScalingIdlFix(lane1.getInstanceSize());
            scaled = lane2;
            constant = lane1;
            newScaled = newLane2;
        }
        ...
        AggregationResult result1 = dR_FP_Succ_GapsAllowed_DifferentSize_TScale_FixedDL
                .tryCombineThrowerAfterCatcher_ThrowerScaleUpGapsAllowed(constant, scaled, newScaled);
        return result1;
    }
    ...
    private AggregationResult scaleDown(Lane lane1, Lane lane2) {
        ...
        AggregationResult result2 = dR_FP_Succ_GapsAllowed_DifferentSize_CScale_FixedDL
                .tryCombineThrowerAfterCatcher_CatcherScaleDown_GapsAllowed(scaled, constant, newScaled);
