...
public class BR_FP_Succ_NoGaps_EqualSize_FlexDL2 implements Aggregator {

    private final PBWSInit2 algorithm;

    public BR_FP_Succ_NoGaps_EqualSize_FlexDL2(PBWSInit2 algorithm) {
    ...
    public AggregationResult tryMigratePath_ThrowerAfterCatcher_EqualInstanceSizes(Lane catcher, Lane thrower) {
        ...
        double newCosts = bu.getCombinedCosts_EqualSize(catcher, thrower, throwShift);
...
//            }
    ...
    public void performCombination(AggregationResult result) {
        ...
        Set<Lane> shifted = thrower.shiftEquallyRecursiveWithAllSuccessors(throwShift);
        shifted.add(catcher);
        shifted.add(thrower);
