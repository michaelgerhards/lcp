...
public class BR_FP_Succ_NoGaps_EqualSize_FixDL2 implements Aggregator {

    public AggregationResult tryCombineThrowerAfterCatcherEqualSizeNoGaps(Lane thrower, Lane catcher) {
