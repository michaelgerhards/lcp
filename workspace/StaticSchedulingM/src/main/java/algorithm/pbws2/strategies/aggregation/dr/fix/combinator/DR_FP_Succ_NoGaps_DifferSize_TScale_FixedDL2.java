...
public class DR_FP_Succ_NoGaps_DifferSize_TScale_FixedDL2 implements Aggregator {

    private final PBWSInit2 algorithm;

    public DR_FP_Succ_NoGaps_DifferSize_TScale_FixedDL2(PBWSInit2 algorithm) {
    ...
    public AggregationResult tryCombineThrowerAfterCatcher_ThrowerScaleNoGaps(
        ...
        if (catcher.getInstanceSize() == thrower.getInstanceSize() || newThrower.getInstanceSize() != catcher.getInstanceSize()) {
