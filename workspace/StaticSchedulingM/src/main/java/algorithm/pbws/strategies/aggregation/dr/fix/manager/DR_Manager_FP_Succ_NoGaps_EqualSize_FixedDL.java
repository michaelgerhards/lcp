...
import algorithm.pbws.strategies.aggregation.dr.fix.combinator.DR_FP_Succ_NoGaps_EqualSize_FixedDL;
import statics.initialization.impl.Lane;

public class DR_Manager_FP_Succ_NoGaps_EqualSize_FixedDL implements DR_Manager_EqualSize {

	public final DR_FP_Succ_NoGaps_EqualSize_FixedDL dR_FP_Succ_NoGaps_EqualSize_FixedDL_CatchUp;

	public DR_Manager_FP_Succ_NoGaps_EqualSize_FixedDL() {
		dR_FP_Succ_NoGaps_EqualSize_FixedDL_CatchUp = new DR_FP_Succ_NoGaps_EqualSize_FixedDL(
				);
	}
