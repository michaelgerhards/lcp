...
public class DR_FP_Succ_GapsAll_DifferSize_CScaleDown_FixedDL implements
        Aggregator {

    public AggregationResult tryCombineThrowerAfterCatcher_CatcherScaleDown_GapsAllowed(
        ...
        if (throwerStartTime - catcherEndtime > -Util.DOUBLE_THRESHOLD) {
            ...
            double catcherAtuEnd = bu
                    .getBillingEndTime(newCatcher);
            double throwerAtuStart = bu
                    .getBillingStartTime(thrower);
