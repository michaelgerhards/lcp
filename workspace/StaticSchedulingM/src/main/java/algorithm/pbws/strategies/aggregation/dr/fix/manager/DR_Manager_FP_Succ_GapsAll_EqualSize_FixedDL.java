...
import algorithm.pbws.strategies.aggregation.dr.fix.combinator.DR_FP_Succ_GapsAll_EqualSize_FixedDL;
import statics.initialization.impl.Lane;
import statics.util.Util;

public class DR_Manager_FP_Succ_GapsAll_EqualSize_FixedDL implements DR_Manager_EqualSize {

	public final DR_FP_Succ_GapsAll_EqualSize_FixedDL dR_FP_Succ_GapsAllowed_EqualSize_FixedDL;

	public DR_Manager_FP_Succ_GapsAll_EqualSize_FixedDL() {
		dR_FP_Succ_GapsAllowed_EqualSize_FixedDL = new DR_FP_Succ_GapsAll_EqualSize_FixedDL();
	}
